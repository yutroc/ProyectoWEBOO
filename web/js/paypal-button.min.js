    ...
    if (!PAYPAL.apps.MiniCart) {
        PAYPAL.apps.MiniCart = function() {
            var d = {}, e = !1, f = !1, g = {_cart: !0, _xclick: !0}, h = "MiniCart_AddToCart_WPS_US", i = /^(?:business|currency_code|lc|paymentaction|no_shipping|cn|no_note|invoice|handling_cart|weight_cart|weight_unit|tax_cart|page_style|image_url|cpp_|cs|cbt|return|cancel_return|notify_url|rm|custom|charset)/, j = function() {
                ...
                var c;
                for (c in b)
                    void 0 !== typeof a[c] && (a[c] = b[c])
            }, n = function() {
                var a, b, d;
                if (a = c.storage.load())
                    for (b = a.length, d = 0; b > d; d++)
                        r(a[d]) && (e = !0)
            }, o = function(a) {
                var b, d, e, f, g = a.elements, h = {};
                for (e = 0, f = g.length; f > e; e++)
                    b = g[e], (d = c.util.getInputValue(b)) && (h[b.name] = d);
                return h
            }, p = function(b) {
                var c, e, f, g, h, j, k, l = {}, m = {};
                for (f in b)
                    i.test(f) ? m[f] = b[f] : l[f] = b[f];
                for (j = 0, g = d.products.length; g > j; j++)
                    if (c = d.products[j].product, l.item_name === c.item_name && l.item_number === c.item_number) {
                        for (h = !0, k = 0; c["os" + k]; ) {
                            if (l["os" + k] !== c["os" + k]) {
                                h = !1;
                                break
                ...
                return{product: l, settings: m}
            }, q = function(b) {
                d.products = [], c.util.setText(d.UI.itemList, ""), c.util.setText(d.UI.subtotalAmount, ""), d.UI.button.value = a.strings.button, n(), d.updateSubtotal(b)
            }, r = function(a) {
                var e, f, g, h = d.UI, i = h.cart, j = new b(a, d.UI.itemList.children.length + 1), k = a.product.offset;
                d.products[k] = j;
                for (g in a.settings)
                    i.elements[g] ? i.elements[g].value ? i.elements[g].value = a.settings[g] : i.elements[g] = a.settings[g] : (f = document.createElement("input"), f.type = "hidden", f.name = g, f.value = a.settings[g], i.appendChild(f));
                if (j.isPlaceholder)
                    return!1;
                ...
                }), h.itemList.insertBefore(j.liNode, h.itemList.firstChild), c.util.animate(j.liNode, "opacity", {from: 0, to: 1}), !0
            }, s = function(b, e) {
                var f = a.events, g = f.onRemoveFromCart, h = f.afterRemoveFromCart;
                ("function" != typeof g || g.call(d, b) !== !1) && (b.setQuantity(0), b.quantityInput.style.display = "none", c.util.animate(b.liNode, "opacity", {from: 1, to: 0}, function() {
                    c.util.animate(b.liNode, "height", {from: 18, to: 0}, function() {
                        try {
                            b.liNode.parentNode.removeChild(b.liNode)
                        } catch (a) {
                        }
                        var c, e, f, g, i, j, k = d.UI.cart.getElementsByTagName("li"), l = k.length, m = 1;
                        for (i = 0; l > i; i++) {
                            for (c = k[i].getElementsByTagName("input"), e = c.length, j = 0; e > j; j++)
                                f = c[j], g = /(.+)_[0-9]+$/.exec(f.name), g && g[1] && (f.name = g[1] + "_" + m);
                            m++
                        }
            ...
            return d.products = [], d.UI = {}, d.render = function(b) {
                var g, h, i, n, o;
                m(b), g = a.events, h = g.onRender, i = g.afterRender, ("function" != typeof h || h.call(d) !== !1) && (f || (j(), k(), l(), n = location.hash.substring(1), 0 === n.indexOf(a.name + "=") && (o = n.split("=")[1], "reset" === o && (d.reset(), location.hash = ""))), q(!0), f || (e ? setTimeout(function() {
                    d.hide(null)
                ...
                if (a.add)
                    ...
                    if (!a.display)
                        return!1;
                    c.event.add(a, "submit", function(a) {
                        a.preventDefault(), d.show(a)
                    })
                }
                return!0
            }, d.addToCart = function(b) {
                var e, f, g = a.events, h = g.onAddToCart, i = g.afterAddToCart, j = !1;
                return b = p(b), f = b.product.offset, "function" != typeof h || h.call(d, b.product) !== !1 ? ((e = this.getProductAtOffset(f)) ? (e.product.quantity += parseInt(b.product.quantity || 1, 10), e.setPrice(b.product.amount * e.product.quantity), e.setQuantity(e.product.quantity), j = !0) : (b.product.offset = d.products.length, j = r(b)), d.updateSubtotal(), d.show(null), c.storage.save(d.products, a.cartDuration), "function" == typeof i && i.call(d, b), j) : void 0
            }, d.getProductAtOffset = function(a) {
                return"undefined" != typeof a && this.products[a]
            }, d.calculateSubtotal = function() {
                var a, b, c, e, f, g, h = 0, i = d.products;
                for (g = 0, f = i.length; f > g; g++)
                    b = i[g], (a = b.product) && a.quantity && a.amount && (c = a.amount, e = b.getDiscount(), h += parseFloat(c * a.quantity - e));
                return h.toFixed(2)
            }, d.updateSubtotal = function(a) {
                var b, e, f, g, h, i = d.UI, j = i.cart.elements, k = i.subtotalAmount, l = d.calculateSubtotal(), m = 1;
                if (b = "", e = "", j.currency_code)
                    b = j.currency_code.value || j.currency_code;
                else
                    for (h = 0, g = j.length; g > h; h++)
                        if ("currency_code" === j[h].name) {
                            b = j[h].value || j[h];
                            break
                        }
                c.util.setText(k, c.util.formatCurrency(l, b)), a || function n() {
                    return f = m.toString(16), m++, k.style.backgroundColor = "#ff" + f, m >= 15 ? (k.style.backgroundColor = "transparent", "0.00" === l && d.reset(), void 0) : (setTimeout(n, 30), void 0)
                }()
            }, d.show = function(b) {
                var f = parseInt(d.UI.cart.offsetTop, 10), g = 0, h = a.events, i = h.onShow, j = h.afterShow;
                b && b.preventDefault && b.preventDefault(), ("function" != typeof i || i.call(d, b) !== !1) && (c.util.animate(d.UI.cart, "top", {from: f, to: g}, function() {
                    "function" == typeof j && j.call(d, b)
                }), d.UI.summary.style.backgroundPosition = "-195px 2px", e = !0)
            }, d.hide = function(b, f) {
                var g, h = d.UI, i = h.cart, j = h.summary, k = i.offsetHeight ? i.offsetHeight : document.defaultView.getComputedStyle(i, "").getPropertyValue("height"), l = j.offsetHeight ? j.offsetHeight : document.defaultView.getComputedStyle(j, "").getPropertyValue("height"), m = parseInt(i.offsetTop, 10), n = a.events, o = n.onHide, p = n.afterHide;
                g = f || 0 === d.products.length || !a.peekEnabled ? -1 * k : -1 * (k - l - 8), b && b.preventDefault && b.preventDefault(), ("function" != typeof o || o.call(d, b) !== !1) && (c.util.animate(i, "top", {from: m, to: g}, function() {
                    "function" == typeof p && p.call(d, b)
                }), j.style.backgroundPosition = "-195px -32px", e = !1)
            }, d.toggle = function(a) {
                e ? d.hide(a) : d.show(a)
            }, d.reset = function() {
                var b = d.UI, f = a.events, g = f.onReset, h = f.afterReset;
                ("function" != typeof g || g.call(d) !== !1) && (d.products = [], e && (c.util.setText(b.itemList, ""), c.util.setText(b.subtotalAmount, ""), d.hide(null, !0)), c.storage.remove(), "function" == typeof h && h.call(d))
            }, d
        }();
        var b = function(a, b) {
            this._view(a, b)
        };
        b.prototype = {_view: function(a, b) {
                var d, e, f, g, h, i, j;
                if (this.product = a.product, this.settings = a.settings, this.liNode = document.createElement("li"), this.nameNode = document.createElement("a"), this.metaNode = document.createElement("span"), this.discountNode = document.createElement("span"), this.discountInput = document.createElement("input"), this.priceNode = document.createElement("span"), this.quantityInput = document.createElement("input"), this.removeInput = document.createElement("input"), !this.product || !this.product.item_name && !this.product.item_number)
                    return this.isPlaceholder = !0, void 0;
                this.product.item_name && (d = this.product.item_name), c.util.setText(this.nameNode, d), this.nameNode.href = this.product.href, this.nameNode.appendChild(this.metaNode), this.product.item_number && c.util.setText(this.metaNode, this.product.item_number, null, "<br>"), h = this.getOptions();
                for (j in h)
                    c.util.setText(this.metaNode, j + ": " + h[j], this.metaNode.innerHTML, "<br>");
                g = this.getDiscount(), g >= 0 && (this.discountInput.type = "hidden", this.discountInput.name = "discount_amount_" + b, this.discountInput.value = g, this.metaNode.appendChild(this.discountInput)), e = this.getPrice(), this.priceNode.className = "price", f = this.getQuantity(), this.quantityInput.name = "quantity_" + b, this.quantityInput.className = "quantity", this.quantityInput.setAttribute("autocomplete", "off"), this.setQuantity(f), this.removeInput.type = "button", this.removeInput.className = "remove", this.liNode.appendChild(this.nameNode), this.liNode.appendChild(this.quantityInput), g && this.liNode.appendChild(this.discountInput), this.liNode.appendChild(this.removeInput), this.liNode.appendChild(this.priceNode);
                for (j in this.product)
                    "quantity" !== j && -1 === j.indexOf("discount_") && (i = document.createElement("input"), i.type = "hidden", i.name = j + "_" + b, i.value = this.product[j], this.liNode.appendChild(i))
            }, getDiscount: function() {
                var a, b = 0, c = this.product.discount_num || -1;
                return this.product.discount_amount >= 0 ? (b = parseFloat(this.product.discount_amount), this.product.discount_amount2 && (a = this.getQuantity(), a > 1 && (b += Math.min(a - 1, c) * parseFloat(this.product.discount_amount2)))) : this.product.discount_rate >= 0 && (b = this.product.amount * parseFloat(this.product.discount_rate) / 100, this.product.discount_rate2 && (a = this.getQuantity(), a > 1 && (b += Math.min(a - 1, c) * this.product.amount * parseFloat(this.product.discount_amount2) / 100))), b && b.toFixed(2)
            }, getOptions: function() {
                for (var a = {}, b = 0; "undefined" != typeof this.product["on" + b]; )
                    a[this.product["on" + b]] = this.product["os" + b], b++;
                return a
            }, setQuantity: function(b) {
                var d;
                b = parseInt(b, 10), this.product.quantity = b, this.quantityInput.value !== b && (this.quantityInput.value = b, (d = this.getDiscount()) && (this.discountInput.value = d, this.discountNode.innerHTML || this.metaNode.appendChild(this.discountNode), c.util.setText(this.discountNode, this.discountNode.innerHTML + a.strings.discount + c.util.formatCurrency(d, this.settings.currency_code)))), this.setPrice(this.product.amount * b)
            }, getQuantity: function() {
                return void 0 !== typeof this.product.quantity ? this.product.quantity : 1
            }, setPrice: function(a) {
                a = parseFloat(a, 10), c.util.setText(this.priceNode, c.util.formatCurrency(a.toFixed(2), this.settings.currency_code))
            }, getPrice: function() {
        ...
        c.storage = function() {
            var b = a.name;
            return window.localStorage ? {load: function() {
                    var a, d, e = localStorage.getItem(b);
                    return e && (e = JSON.parse(decodeURIComponent(e))), e && e.expires && (a = new Date, d = new Date(e.expires), a > d) ? (c.storage.remove(), void 0) : e && e.value ? e.value : e
                }, save: function(a, c) {
                    var d, e, f, g, h = new Date, i = [];
                    if (a) {
                        for (g = 0, f = a.length; f > g; g++)
                            e = a[g], i.push({product: e.product, settings: e.settings});
                        h.setTime(h.getTime() + 1e3 * 60 * 60 * 24 * c), d = {value: i, expires: h.toGMTString()}, localStorage.setItem(b, encodeURIComponent(JSON.stringify(d)))
                    }
                }, remove: function() {
                    ...
                    var d, e, f, g = new Date, h = [];
                    if (b) {
                        for (f = 0, e = b.length; e > f; f++)
                            d = b[f], h.push({product: d.product, settings: d.settings});
                        g.setTime(g.getTime() + 1e3 * 60 * 60 * 24 * c), document.cookie = a.name + "=" + encodeURIComponent(JSON.stringify(h)) + "; expires=" + g.toGMTString() + "; path=" + a.cookiePath
                    }
                }, remove: function() {
                    this.save(null, -1)
                }}
            ...
            var a = [];
            return document.addEventListener ? {add: function(b, c, d, e) {
                    e = e || b;
                    var f = function(a) {
                        d.call(e, a)
                    };
                    b.addEventListener(c, f, !1), a.push([b, c, d, f])
                }, remove: function(b, c, d) {
                    var e, f, g, h = a.length;
                    for (g = 0; h > g; g++)
                        f = a[g], f[0] === b && f[1] === c && f[2] === d && (e = f[3], e && (b.removeEventListener(c, e, !1), delete a[g]))
                }} : document.attachEvent ? {add: function(b, c, d, e) {
                    e = e || b;
                    var f = function() {
                        var a = window.event;
                        a.target = a.target || a.srcElement, a.preventDefault = function() {
                            a.returnValue = !1
                        }, d.call(e, a)
                    };
                    b.attachEvent("on" + c, f), a.push([b, c, d, f])
                }, remove: function(b, c, d) {
                    var e, f, g, h = a.length;
                    for (g = 0; h > g; g++)
                        f = a[g], f[0] === b && f[1] === c && f[2] === d && (e = f[3], e && (b.detachEvent("on" + c, e), delete a[g]))
                }} : void 0
        }(), c.util = {animate: function(a, b, c, d) {
                c = c || {}, c.from = c.from || 0, c.to = c.to || 0, c.duration = c.duration || 10, c.unit = /top|bottom|left|right|width|height/.test(b) ? "px" : "";
                var e = (c.to - c.from) / 20, f = c.from;
                !function g() {
                    return a.style[b] = f + c.unit, f += e, e > 0 && f > c.to || 0 > e && f < c.to || 0 === e ? (a.style[b] = c.to + c.unit, "function" == typeof d && d(), void 0) : (setTimeout(g, c.duration), void 0)
                }()
...
PAYPAL.apps = PAYPAL.apps || {}, function(a) {
    ...
    function d(b, c) {
        ...
        c = c && c.value || 250;
        for (e in l)
            d = l[e], j += d.key + "=" + encodeURIComponent(d.value) + "&";
    ...
    function e(a) {
        ...
        if (b = a.attributes)
            for (f = 0, e = b.length; e > f; f++)
                c = b[f], (d = c.name.match(/^data-([a-z0-9_]+)(-editable)?/i)) && (g[d[1]] = {value: c.value, isEditable: !!d[2]});
        return g
    }
    function f() {
    ...
    if (PAYPAL.apps.ButtonFactory || (g.config = {labels: {}}, g.buttons = {buynow: 0, cart: 0, donate: 0, qr: 0, subscribe: 0}, g.create = function(a, e, g, h) {
        ...
        if (!a)
            return!1;
        for (l in e)
            n.add(k[l] || l, e[l].value, e[l].isEditable);
        ...
        for (q = 0, r = t.length; r > q; q++)
            m = t[q], m && m.src && (n = m && e(m), o = n && n.button && n.button.value, p = m.src.split("?merchant=")[1], p && (s.create(p, n, o, m.parentNode), m.parentNode.removeChild(m)))
    }
